...
class Showkidsticket extends StatelessWidget {
  int? index;
   Showkidsticket({Key? key,this.index}) : super(key: key);
...
class TicketData extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final kids=context.watch<Ticketcontroller>();
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ticketDetailsWidget('Persons', '1', 'Date', "12-01-2025"),
              Padding(
                padding: const EdgeInsets.only(top: 12.0, right: 52.0),
                child: ticketDetailsWidget('Ticket No', '6415', 'Price', kids.kidscount.toString()),
              ),
