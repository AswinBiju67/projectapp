...
class Showmusicticket extends StatelessWidget {
  int? index;
   Showmusicticket({Key? key,this.index}) : super(key: key);
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ticketDetailsWidget('Ticket Type', 'Lolla VIP', 'Date', '28-08-2025'),
              Padding(
                padding: const EdgeInsets.only(top: 12.0, right: 52.0),
                child: ticketDetailsWidget('Ticket No', '6415', 'Price', '13999'),
              ),
