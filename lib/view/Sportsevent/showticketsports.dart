...
class Showticketsports extends StatelessWidget {
  int? index;
   Showticketsports({Key? key,this.index}) : super(key: key);
...
class TicketData extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final sports=context.watch<Ticketcontroller>();
    return Column(
      ...
      children: [
        ...
        const Padding(
          ...
          child: Text(
            'Location : Jawaharlal Neharu Stadium: Chennai',
        ...
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ticketDetailsWidget('Persons', sports.person.toString(), 'Date', '28-08-2025'),
              Padding(
                padding: const EdgeInsets.only(top: 12.0, right: 52.0),
                child: ticketDetailsWidget('Ticket No', '6415', 'Price', sports.ratesp.toString()),
              ),
